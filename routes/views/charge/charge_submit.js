...
exports = module.exports = function(req, res) { 
    ...
    view.on('post', function(next) {
        ...
        new_order.save(function(err, order_result){
            ...
            var signature = sign(order_result.payer, order_result.total_amount, order_result._id, order_result.timestamp);
            ...
            locals.data['return_url'] = "http://www.crongkj.com:3000/show_user";
            locals.data['notify_url'] = "http://www.crongkj.com:3000/charge_confirm";
            locals.data['charset'] = "GBK";
            locals.data['method'] = "alipay.trade.page.pay";
