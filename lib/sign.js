...
var default_parameter = {
    ...
    biz_content: "{}",
    charset: "UTF-8",
    return_url: "http://www.crongkj.com:3000/showuser",
...
exports = module.exports = function(user_id, total_amount, order_id, time_stamp, mode){
    //Get data
    ...
    default_parameter.method = (mode == 'PC')?"alipay.trade.page.pay":"alipay.trade.wap.pay";
